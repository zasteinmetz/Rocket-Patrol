class Menu extends Phaser.Scene{
    ...
    create(){
        ...
        // show menu text
        this.add.text(game.config.width/2, game.config.height/2 - 4 * (borderUISize + borderPadding), 'ROCKET PATROL', menuConfig).setOrigin(0.5);
        ...
        this.add.text(game.config.width/2, game.config.height/2 - (borderUISize + borderPadding), 'Use <--> to move & 0(Numpad) to fire', menuConfig).setOrigin(0.5);
        menuConfig.backgroundColor = '#c0f';
